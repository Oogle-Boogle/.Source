...
import com.platinum.model.input.impl.EnterClanChatToJoin;
import com.platinum.model.input.impl.EnterSyntaxToBankSearchFor;
...
import com.platinum.world.content.Emotes;
...
import com.platinum.world.content.ItemsKeptOnDeath;
import com.platinum.world.content.KillsTracker;
...
import com.platinum.world.content.PlayersOnlineInterface;
...
import com.platinum.world.content.StartScreen;
import com.platinum.world.content.StarterTasks;
import com.platinum.world.content.WellOfGoodwill;
import com.platinum.world.content.clan.ClanChat;
import com.platinum.world.content.clan.ClanChatManager;
import com.platinum.world.content.collectionlog.SearchForCollectionNpc;
import com.platinum.world.content.combat.magic.Autocasting;
import com.platinum.world.content.combat.magic.MagicSpells;
...
import com.platinum.world.content.crashgame.CrashGame;
import com.platinum.world.content.crashgame.HandleCrashAutoCashoutChange;
import com.platinum.world.content.crashgame.HandleCrashBetChange;
import com.platinum.world.content.crashgame.HandleCrashDeposit;
import com.platinum.world.content.crashgame.HandleCrashWithdraw;
import com.platinum.world.content.customraids.RaidDifficulty;
import com.platinum.world.content.customraids.RaidParty;
import com.platinum.world.content.customraids.input.JoinPartyInputListener;
...
import com.platinum.world.content.droppreview.CORP;
import com.platinum.world.content.droppreview.DAGS;
import com.platinum.world.content.droppreview.GLAC;
import com.platinum.world.content.droppreview.GWD;
import com.platinum.world.content.droppreview.KALPH;
import com.platinum.world.content.droppreview.KBD;
import com.platinum.world.content.droppreview.LIZARD;
import com.platinum.world.content.droppreview.NEXX;
import com.platinum.world.content.droppreview.PHEON;
import com.platinum.world.content.droppreview.SKOT;
...
import com.platinum.world.content.groupironman.input.KickPlayerInputListener;
...
import com.platinum.world.content.roulette.Roulette.BetType;
import com.platinum.world.content.roulette.RouletteDeposit;
...
import com.platinum.world.content.skill.impl.dungeoneering.DungeoneeringParty;
...
import com.platinum.world.content.skill.impl.herblore.IngridientsBook;
import com.platinum.world.content.skill.impl.slayer.Slayer;
...
import com.platinum.world.content.skill.impl.summoning.SummoningTab;
import com.platinum.world.content.teleportation.Teleporting;
import com.platinum.world.content.teleportation.teleportsystem.BossInformation;
...
public class ButtonClickPacketListener implements PacketListener {
    ...
    public void handleMessage(Player player, Packet packet) {
		...
		case -19031:
            ...
            case -26209:
            case -26212:
                new com.platinum.world.content.scratchcard.ScratchCard(player).reveal(id);
                break;
             ...
             */
        		...
        		case -12832:
                     ...
                     World.sendMessageNonDiscord("<shad=0>@red@ [News] " + player.getUsername() + "@cya@ has Fused together a " + ItemDefinition.forId(CombineEnum.values()[player.combineIndex].getEndItem()).getName() + "!");
            ...
            case 27229:
                ...
                break;
            case 3229:
                player.sendMessage("Common Costs 50 platinum Points.");
                break;
            case 3218:
                player.sendMessage("Uncommon Package Costs 100 platinum Points.");
                break;
            case 3215:
                player.sendMessage("Extreme Package Costs 200 platinum Points.");
                break;
            case 3221:
                player.sendMessage("Rare Package Costs 150 platinum Points.");
                break;
            case 3235:
                player.sendMessage("Legendary Package Costs 250 platinum Points.");
                break;
            case 3204:
            ...
            case 8668:
                ...
                break;
            case 8665:
                TeleportHandler.teleportPlayer(player, new Position(3222, 3204), player.getSpellbook()
                        .getTeleportType());
                break;
            case 8662:
            ...
            case 1018:
                ...
                break;
            case 11004:
                TeleportHandler.teleportPlayer(player, new Position(2336, 3715), player.getSpellbook()
                        .getTeleportType());
                break;
            case 8654:
            case 8657:
