...
import com.platinum.engine.task.impl.HPRegainPotionTask;
import com.platinum.engine.task.impl.PraiseTask;
import com.platinum.engine.task.impl.PrayerRegainPotionTask;
import com.platinum.engine.task.impl.SpecialRegainPotionTask;
...
import com.platinum.world.content.skill.impl.herblore.Herblore;
import com.platinum.world.content.skill.impl.herblore.IngridientsBook;
import com.platinum.world.content.skill.impl.hunter.BoxTrap;
import com.platinum.world.content.skill.impl.hunter.Hunter;
import com.platinum.world.content.skill.impl.hunter.JarData;
import com.platinum.world.content.skill.impl.hunter.PuroPuro;
import com.platinum.world.content.skill.impl.hunter.SnareTrap;
import com.platinum.world.content.skill.impl.hunter.Trap.TrapState;
import com.platinum.world.content.skill.impl.prayer.Prayer;
import com.platinum.world.content.skill.impl.runecrafting.Runecrafting;
import com.platinum.world.content.skill.impl.runecrafting.RunecraftingPouches;
import com.platinum.world.content.skill.impl.runecrafting.RunecraftingPouches.RunecraftingPouch;
...
import com.platinum.world.content.skill.impl.summoning.CharmingImp;
import com.platinum.world.content.skill.impl.summoning.SummoningData;
import com.platinum.world.content.skill.impl.woodcutting.BirdNests;
...
import com.platinum.world.content.treasuretrails.ClueScroll;
import com.platinum.world.content.treasuretrails.CoordinateScrolls;
import com.platinum.world.content.treasuretrails.DiggingScrolls;
import com.platinum.world.content.treasuretrails.MapScrolls;
import com.platinum.world.content.treasuretrails.Puzzle;
import com.platinum.world.content.treasuretrails.SearchScrolls;
...
public class ItemActionPacketListener implements PacketListener {
	...
	private static void firstAction(final Player player, Packet packet) {
		...
		case 455:
			new com.platinum.world.content.scratchcard.ScratchCard(player).display();
			break;
		...
		case 18702:
			...
			player.getPacketSender().sendString(8144, "@dre@Platinum's Starter Guide");
		...
		case 18768:
			...
			break;
		case 19901:
			int[] bravekCasketRewards = { 3980, 15454, 15459, 15464, 15449, 15374, 18768, 3069, 3071, 3981, 5133,
	...
	public void thirdClickAction(Player player, Packet packet) {
		...
		case 8654:
			if (player.getInventory().contains(10835) && player.getInventory().getAmount(10835) >= 500) {
				player.getInventory().delete(8654, 1).delete(10835, 500).add(8655, 1);
				player.getPacketSender().sendMessage("You have Successfully Switched your Imbued Weapon");
			} else {
				player.getPacketSender().sendMessage(
