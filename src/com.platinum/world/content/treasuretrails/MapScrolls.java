...
/**
 * Created by IntelliJ IDEA. User: levi Date: 11/14/16 Time: 16:08 To change
...
public class MapScrolls {
	...
	public static enum MapCluesData {
		BLACK_FORTERESS(2713, 9507, new Position(3026, 3628), true, 2), GALAHAD(
				...
				2719, 6994, new Position(3166, 3360), false, 2), FALADOR_ROCK(
				2722, 7271, new Position(3043, 3399), false, 2), DRAYNOR(2827,
				7113, new Position(3092, 3226), false, 2), GOBLIN_VILLAGE(2829,
				9454, new Position(2459, 3179), true, 3), NECROMANCER(3516,
				9632, new Position(2654, 3233), false, 3), LUMBERYARD(3518,
				7221, new Position(3309, 3503), true, 1), VARROCK_MINE(3520,
				7045, new Position(3290, 3373), false, 1), /*YANILLE(3522, 9040,
				new Position(2616, 3077), false, 1),*/ RIMMINGTON(3524, 9839,
				new Position(2924, 3209), false, 1), HOBGOBLIN(3525, 4305,
				new Position(2906, 3294), false, 2), MCGRUBOR(3596, 9196,
				new Position(2658, 3488), true, 2), CLOCK_TOWER(3599, 9720,
				new Position(2565, 3248), true, 1), WEST_ARDOUGNE(3601, 9359,
				new Position(2488, 3308), false, 1), WIZARD_TOWER(3602, 9275,
				new Position(3109, 3153), false, 2), MORT_TON(7236, 17774,
				new Position(3434, 3265), false, 3), CHAOS_ALTAR(7239, 17888,
				new Position(2454, 3230), false, 3), WILDERNESS_AGILITY(7241,
				17620, new Position(3021, 3912), false, 2), MISCELLANIA(7286,
				17687, new Position(2535, 3865), false, 1), CAMELOT(7288,
				18055, new Position(2666, 3562), false, 3), LEGEND_GUILD(7290,
				17634, new Position(2723, 3339), false, 3), FALADOR_STATUE(
				7292, 17537, new Position(2970, 3414), false, 2), RELLEKA(7294,
				17907, new Position(2579, 3597), false, 2), CRAFTING_GUILD_EAST(
				3598, 7162, new Position(2702, 3428), false, 1);
		...
		MapCluesData(int clueId, int interfaceId, Position finalPosition,
