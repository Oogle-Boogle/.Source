...
public class DragonMultiDrop extends NPC {
	...
	public static void spawn() {
		...
		World.sendMessage("<img=10>@red@The Event NPC has spawned at the " + location.getLocation() + "!");
	}
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		if (chance >= 999) {
			...
			World.sendMessage(
					"<img=10><col=FF0000>" + player.getUsername() + " received " + itemMessage + " from the Hellfire Dragon!");
			return;
		}
