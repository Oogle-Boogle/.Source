...
public class Tztok extends NPC {
	...
	public static int[] RARELOOT = { 5131,4771,4772,4770,5131,4771,4772,4770, 4799 ,4800,4801,5079,3973,3951,15012
			,5131,4770,4771,4772,3988};
	public static int[] SUPERRARELOOT = {11978,19140,19886,6320,4058,4057,4056,4059,19890,12162 };
	...
	public static void spawn() {
		...
		World.sendMessageNonDiscord("<img=11><col=bababa>[<col=0999ad><shad=200>WORLD BOSS<col=bababa>]<col=0999ad>The World Boss has Respawned at <col=00a745>" + location.getLocation() + "");
	}
