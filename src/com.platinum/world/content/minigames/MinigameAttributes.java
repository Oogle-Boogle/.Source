package com.platinum.world.content.minigames;
...
public class MinigameAttributes {
	...
	private final GunGameAttributes gunGameAttributes = new GunGameAttributes();

	public class GunGameAttributes {
		private int wave;
		...
		public int getWaveSpawn() {
			return waveSpawn;
		}

		public void setWaveSpawn(int waveSpawn) {
	...
	public GunGameAttributes getGunGameAttributes() {
		return gunGameAttributes;
	}
