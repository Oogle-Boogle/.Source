...
public class WarriorsGuild {
	 ...
	 */
	private static final int[] DEFENDERS = new int[]{20693, 20694, 20695, 20696, 20697, 20698, 20699, 20700};
	...
	public static Dialogue warriorsGuildDialogue(final Player player) {
		return new Dialogue() {
			...
			public String[] dialogue() {
				...
				return new String[] {"I'll release some Frankenstiens which might drop", ""+ItemDefinition.forId(defender).getName().replace(" defender", "")+" Defenders for you.", "Good luck warrior!"};
				//player.getPacketSender().sendItemOnInterface(defender, 2, 2);
