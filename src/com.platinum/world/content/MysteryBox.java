...
public class MysteryBox {
	...
	public void process() {
		...
		int rewards2[][] = {
				...
				{18380,18381,18382,9006,3941,3974,18392,4799,4800,4801}, //Uncommon, 1
				{15012,1499,3951,5079,3960,3958,3959,5187,5186,3316,3931,14559,6583} };
		...
		int[] veryUncommon = { 18380,18381,18382,9006,3941,3974,18392,4799,4800,4801 };
		int[] rare = { 18380,18381,18382,9006,3941,3974,18392,4799,4800,4801};
		int[] veryRare = { 18380,18381,18382,9006,3941,3974,18392,4799,4800,4801};
		int[] extremelyRare = { 15012,1499,3951,5079,3960,3958,3959,5187,5186,3316,3931,14559,6583 };
		int[] legendary = {15012,1499,3951,5079,3960,3958,3959,5187,5186,3316,3931,14559,6583 };
	...
	public void reward() {
		...
		if (mysteryPrize == 19886 || mysteryPrize == 3666 || mysteryPrize == 3664 || mysteryPrize == 18896 || mysteryPrize == 3662 || mysteryPrize == 17776 || mysteryPrize == 5130 || mysteryPrize == 3072 || mysteryPrize == 18998 || mysteryPrize == 3074 || mysteryPrize == 18954 || mysteryPrize == 18949 || mysteryPrize == 18953 || mysteryPrize == 18962 || mysteryPrize == 18955 || mysteryPrize == 18956) {
			World.sendMessageNonDiscord("[<img=10>][@red@Mega Or Ultra Mystery Box@bla@] @red@"+plr.getUsername()+"@bla@ has won a "+tier +name+"@bla@!");
		}
