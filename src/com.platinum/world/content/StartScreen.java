    ...
    public static boolean handleButton(Player player, int buttonId) {
        ...
        if (buttonId == CONFIRM) {
            ...
            if (!PlayerPunishment.hasRecieved1stStarter(player.getHostAddress())) {
                ...
                World.sendMessage("<col=008FB2><shad=200>[<img=40>NEW PLAYER<img=40>]: " + player.getUsername() + " has logged into Platinum for the first time!");
                World.sendMessage(
                ...
                World.sendMessage("<col=008FB2><shad=200>[<img=10>NEW PLAYER<img=10>]: " + player.getUsername() + " has logged into Platinum for the first time!");
                World.sendMessage(
                        "<img=10> <col=008FB2><shad=200>Please give him/her a super warm welcome <3");
