...
public class CrexDrops extends NPC {
	public static Item[] COMMONLOOT = { new Item(10835, 2) };

	public static Item[] RARELOOT = { new Item(10835, 4) };

	public static Item[] SUPERRARELOOT = { new Item(3907), new Item(3908), new Item(3909), new Item(3910) };
	
	/**
	 * 
	 */
	public static final int NPC_ID = 9277;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final CrexDropsLocation[] LOCATIONS = { new CrexDropsLocation(2597, 3157, 0, "Fight arena! @ ::arena") };

	/**
	 * 
	 */
	private static CrexDrops current;

	/**
	 * 
	 * @param position
	 */
	public CrexDrops(Position position) {
	...
	public static void spawn() {
		...
		World.sendFilteredMessage("<img=10>@red@The CrexDrops has spawned at the " + location.getLocation() + "!");
	}
	 ...
	 * @return
	 */
	public static CrexDrops getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(CrexDrops current) {
		CrexDrops.current = current;
	}
	 ...
	 *
	 */
	public static class CrexDropsLocation extends Position {
		 ...
		 * @param location
		 */
		public CrexDropsLocation(int x, int y, int z, String location) {
			super(x, y, z);
