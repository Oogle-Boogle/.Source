...
public class Achievements {
	...
	public enum AchievementData {
		...
		FILL_WELL_OF_GOODWILL_1M(Difficulty.EASY, "Pour 1m Into The Well", 45006, null, "", "", "", "", "", "", new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		CUT_AN_OAK_TREE(Difficulty.EASY, "Cut An Oak Tree", 45007, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		BURN_AN_OAK_LOG(Difficulty.EASY, "Burn An Oak Log", 45008, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		FISH_A_SALMON(Difficulty.EASY, "Fish A Salmon", 45009, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		COOK_A_SALMON(Difficulty.EASY, "Cook A Salmon", 45010, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		EAT_A_SALMON(Difficulty.EASY, "Eat A Salmon", 45011, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		MINE_SOME_IRON(Difficulty.EASY, "Mine Some Iron", 45012, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		SMELT_AN_IRON_BAR(Difficulty.EASY, "Smelt An Iron Bar", 45013, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		HARVEST_A_CROP(Difficulty.EASY, "Harvest A Crop", 45014, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		INFUSE_A_DREADFOWL_POUCH(Difficulty.EASY, "Infuse A Dreadfowl Pouch", 45015, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		CATCH_A_YOUNG_IMPLING(Difficulty.EASY, "Catch A Young Impling", 45016, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		...
		CLIMB_AN_AGILITY_OBSTACLE(Difficulty.EASY, "Climb An Agility Obstacle", 45018, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		FLETCH_SOME_ARROWS(Difficulty.EASY, "Fletch Some Arrows", 45019, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		STEAL_A_RING(Difficulty.EASY, "Steal A Ring", 45020, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		MIX_A_POTION(Difficulty.EASY, "Mix A Potion", 45021, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		RUNECRAFT_SOME_RUNES(Difficulty.EASY, "Runecraft Some Runes", 45022, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		BURY_A_BIG_BONE(Difficulty.EASY, "Bury A Big Bone", 45023, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		COMPLETE_A_SLAYER_TASK(Difficulty.EASY, "Complete A Slayer Task", 45024, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		SET_UP_A_CANNON(Difficulty.EASY, "Set Up A Cannon", 45025, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		KILL_A_MONSTER_USING_MELEE(Difficulty.EASY, "Kill a Monster Using Melee", 45026, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		KILL_A_MONSTER_USING_RANGED(Difficulty.EASY, "Kill a Monster Using Ranged", 45027, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		KILL_A_MONSTER_USING_MAGIC(Difficulty.EASY, "Kill a Monster Using Magic", 45028, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_MELEE(Difficulty.EASY, "Deal 1000 Melee Damage", 45029, new int[]{0, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_RANGED(Difficulty.EASY, "Deal 1000 Ranged Damage", 45030, new int[]{1, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_MAGIC(Difficulty.EASY, "Deal 1000 Magic Damage", 45031, new int[]{2, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		PERFORM_A_SPECIAL_ATTACK(Difficulty.EASY, "Perform a Special Attack", 45032, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		FIGHT_ANOTHER_PLAYER(Difficulty.EASY, "Fight Another Player", 45033, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(989, 1), new Item(19864, 10)),
		...
		FILL_WELL_OF_GOODWILL_250M(Difficulty.HARD, "Pour 250M Into The Well", 45070, new int[]{25, 5}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		CUT_5000_MAGIC_LOGS(Difficulty.HARD, "Cut 5000 Magic Logs", 45071, new int[]{26, 5000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		BURN_2500_MAGIC_LOGS(Difficulty.HARD, "Burn 2500 Magic Logs", 45072, new int[]{27, 2500}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		FISH_2000_ROCKTAILS(Difficulty.HARD, "Fish 2000 Rocktails", 45073, new int[]{28, 2000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		COOK_1000_ROCKTAILS(Difficulty.HARD, "Cook 1000 Rocktails", 45074, new int[]{29, 1000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		MINE_2000_RUNITE_ORES(Difficulty.HARD, "Mine 2000 Runite Ores", 45075, new int[]{30, 2000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		SMELT_1000_RUNE_BARS(Difficulty.HARD, "Smelt 1000 Rune Bars", 45076, new int[]{31, 1000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		HARVEST_1000_TORSTOLS(Difficulty.HARD, "Harvest 1000 Torstols", 45077, new int[]{32, 1000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		INFUSE_500_STEEL_TITAN_POUCHES(Difficulty.HARD, "Infuse 500 Steel Titans", 45078, new int[]{33, 500}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		CRAFT_1000_DIAMOND_GEMS(Difficulty.HARD, "Craft 1000 Diamond Gems", 45079, new int[]{34, 1000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		CATCH_100_KINGLY_IMPLINGS(Difficulty.HARD, "Catch 100 Kingly Imps", 45080, new int[]{35, 100}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		FLETCH_5000_RUNE_ARROWS(Difficulty.HARD, "Fletch 5000 Rune Arrows", 45081, new int[]{36, 5000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		STEAL_5000_SCIMITARS(Difficulty.HARD, "Steal 5000 Scimitars", 45082, new int[]{45, 5000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		RUNECRAFT_8000_BLOOD_RUNES(Difficulty.HARD, "Runecraft 8000 Blood Runes", 45083, new int[]{38, 8000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		BURY_500_FROST_DRAGON_BONES(Difficulty.HARD, "Bury 500 Frost Dragon Bones", 45084, new int[]{39, 500}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		FIRE_5000_CANNON_BALLS(Difficulty.HARD, "Fire 5000 Cannon Balls", 45085, new int[]{40, 5000}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		MIX_100_OVERLOAD_POTIONS(Difficulty.HARD, "Mix 100 Overload Potions", 45086, new int[]{41, 100}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		COMPLETE_AN_ELITE_SLAYER_TASK(Difficulty.HARD, "Complete An Elite Slayer Task", 45087, null, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 25)),
		ASSEMBLE_5_GODSWORDS(Difficulty.HARD, "Assemble 5 Godswords", 45088, new int[]{42, 5}, "", "", "", "", "", "", new Item(10835, 5), new Item(15373, 2), new Item(7629, 250)),
		DEAL_HARD_DAMAGE_USING_MELEE(Difficulty.HARD, "Deal 5M Melee Damage", 45089, new int[]{43, 5000000}, "", "", "", "", "", "", new Item(10835, 25), new Item(15373, 1), new Item(7629, 25)),
		DEAL_HARD_DAMAGE_USING_RANGED(Difficulty.HARD, "Deal 5M Ranged Damage", 45090, new int[]{44, 5000000}, "", "", "", "", "", "", new Item(10835, 25), new Item(15373, 1), new Item(7629, 25)),
		DEAL_HARD_DAMAGE_USING_MAGIC(Difficulty.HARD, "Deal 5M Magic Damage", 45091, new int[]{45, 5000000}, "", "", "", "", "", "", new Item(10835, 25), new Item(15373, 1), new Item(7629, 25)),
		DEFEAT_JAD(Difficulty.HARD, "Defeat Jad", 45092, null, "", "", "", "", "", "", new Item(10835, 50), new Item(6199, 1), new Item(7629, 25)),
		DEFEAT_BANDOS_AVATAR(Difficulty.HARD, "Defeat Bandos Avatar", 45093, null, "", "", "", "", "", "", new Item(10835, 5), new Item(6199, 2), new Item(7629, 25)),
		DEFEAT_GENERAL_GRAARDOR(Difficulty.HARD, "Defeat General Graardor", 45094, null, "", "", "", "", "", "", new Item(10835, 5), new Item(6199, 2), new Item(7629, 25)),
		DEFEAT_KREE_ARRA(Difficulty.HARD, "Defeat Kree'Arra", 45095, null, "", "", "", "", "", "", new Item(10835, 5), new Item(6199, 2), new Item(7629, 25)),
		DEFEAT_COMMANDER_ZILYANA(Difficulty.HARD, "Defeat Commander Zilyana", 45096, null, "", "", "", "", "", "", new Item(10835, 5), new Item(6199, 2), new Item(7629, 25)),
		DEFEAT_KRIL_TSUTSAROTH(Difficulty.HARD, "Defeat K'ril Tsutsaroth", 45097, null, "", "", "", "", "", "", new Item(10835, 5), new Item(6199, 2), new Item(7629, 25)),
		DEFEAT_THE_CORPOREAL_BEAST(Difficulty.HARD, "Defeat The Corporeal Beast", 45098, null, "", "", "", "", "", "", new Item(10835, 50), new Item(6199, 1), new Item(7629, 25)),
		DEFEAT_NEX(Difficulty.HARD, "Defeat Nex", 45099, null, "", "", "", "", "", "", new Item(10835, 5000), new Item(19935, 1), new Item(7629, 100)),
		...
		CUT_AN_ONYX_STONE(Difficulty.ELITE, "Cut An Onyx Stone", 45105, null, "", "", "", "", "", "", new Item(10835, 2), new Item(6199, 1), new Item(989, 5)),
		...
		DEFEAT_500_BOSSES(Difficulty.ELITE, "Defeat 500 Boss Monsters", 45109, new int[]{50, 500}, "", "", "", "", "", "", new Item(10835, 1000), new Item(6199, 5), new Item(7629, 25)),
		;
