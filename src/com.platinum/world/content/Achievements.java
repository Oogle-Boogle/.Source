...
public class Achievements {
	...
	public enum AchievementData {
		...
		FILL_WELL_OF_GOODWILL_1M(Difficulty.EASY, "Pour 1m Into The Well", 45006, null, "", "", "", "", "", "", new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		CUT_AN_OAK_TREE(Difficulty.EASY, "Cut An Oak Tree", 45007, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		BURN_AN_OAK_LOG(Difficulty.EASY, "Burn An Oak Log", 45008, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		FISH_A_SALMON(Difficulty.EASY, "Fish A Salmon", 45009, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		COOK_A_SALMON(Difficulty.EASY, "Cook A Salmon", 45010, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		EAT_A_SALMON(Difficulty.EASY, "Eat A Salmon", 45011, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		MINE_SOME_IRON(Difficulty.EASY, "Mine Some Iron", 45012, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		SMELT_AN_IRON_BAR(Difficulty.EASY, "Smelt An Iron Bar", 45013, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		HARVEST_A_CROP(Difficulty.EASY, "Harvest A Crop", 45014, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		INFUSE_A_DREADFOWL_POUCH(Difficulty.EASY, "Infuse A Dreadfowl Pouch", 45015, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		CATCH_A_YOUNG_IMPLING(Difficulty.EASY, "Catch A Young Impling", 45016, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		CRAFT_A_PAIR_OF_LEATHER_BOOTS(Difficulty.EASY, "Craft A Pair of Leather Boots", 45017, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		CLIMB_AN_AGILITY_OBSTACLE(Difficulty.EASY, "Climb An Agility Obstacle", 45018, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		FLETCH_SOME_ARROWS(Difficulty.EASY, "Fletch Some Arrows", 45019, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		STEAL_A_RING(Difficulty.EASY, "Steal A Ring", 45020, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		MIX_A_POTION(Difficulty.EASY, "Mix A Potion", 45021, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		RUNECRAFT_SOME_RUNES(Difficulty.EASY, "Runecraft Some Runes", 45022, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		BURY_A_BIG_BONE(Difficulty.EASY, "Bury A Big Bone", 45023, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		COMPLETE_A_SLAYER_TASK(Difficulty.EASY, "Complete A Slayer Task", 45024, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		SET_UP_A_CANNON(Difficulty.EASY, "Set Up A Cannon", 45025, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		KILL_A_MONSTER_USING_MELEE(Difficulty.EASY, "Kill a Monster Using Melee", 45026, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		KILL_A_MONSTER_USING_RANGED(Difficulty.EASY, "Kill a Monster Using Ranged", 45027, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		KILL_A_MONSTER_USING_MAGIC(Difficulty.EASY, "Kill a Monster Using Magic", 45028, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_MELEE(Difficulty.EASY, "Deal 1000 Melee Damage", 45029, new int[]{0, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_RANGED(Difficulty.EASY, "Deal 1000 Ranged Damage", 45030, new int[]{1, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_MAGIC(Difficulty.EASY, "Deal 1000 Magic Damage", 45031, new int[]{2, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		PERFORM_A_SPECIAL_ATTACK(Difficulty.EASY, "Perform a Special Attack", 45032, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		FIGHT_ANOTHER_PLAYER(Difficulty.EASY, "Fight Another Player", 45033, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
