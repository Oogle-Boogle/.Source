...
package com.platinum.world.content.dissolving;
					...
					TimerTask task = new TimerTask() {
						...
						public void run() {
							if (tick == 0) {
								...
								if (success) {
									World.sendMessageNonDiscord("<img=382><col=FF0000><shad=200>" + player.getUsername() + " @gre@Successfully<col=FF0000> dissolved their " + val.getReward().getDefinition().getName() + " !");
