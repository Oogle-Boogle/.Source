package com.platinum.world.content.skill.impl.dungeoneering;
...
import com.platinum.world.content.dialogue.impl.DungPartyInvitation;
	...
	public void remove(Player p, boolean resetTab, boolean fromParty) {
		...
		if(hasEnteredDungeon) {
			...
			if(exp > 0 && tokens > 0) {
				...
				p.getPacketSender().sendMessage("<img=11> <col=660000>You've received Dungeoneering experience and "+tokens+" Dungeoneering tokens.");
