package com.platinum.world.content.skill.impl.runecrafting;
...
import com.platinum.world.content.skill.impl.runecrafting.RunecraftingData.RuneData;
import com.platinum.world.content.skill.impl.runecrafting.RunecraftingData.TalismanData;
...
public class Runecrafting {
	...
	public static void craftRunes(final Player player, RunecraftingData.RuneData rune) {
		...
		if(Misc.getRandom(2000) == 3) {
			...
			World.sendMessageNonDiscord("@blu@<img=11>[Skilling Pets] "+player.getUsername()+" has received the Rift Guardian pet!");
