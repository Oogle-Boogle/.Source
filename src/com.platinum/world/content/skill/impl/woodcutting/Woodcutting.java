...
import com.platinum.world.content.skill.impl.firemaking.Logdata;
import com.platinum.world.content.skill.impl.firemaking.Logdata.logData;
...
import com.platinum.world.content.skill.impl.woodcutting.WoodcuttingData.Trees;
...
public class Woodcutting {
	...
	public static void cutWood(final Player player, final GameObject object, boolean restarting) {
		...
		if (Misc.getRandom(25000) == 3) {
			...
			World.sendMessageNonDiscord("@blu@<img=11>[Skilling Pets] " + player.getUsername() + " has received the Beaver pet!");
									...
									if (t == Trees.MAGIC || t == Trees.CUSTOM_TREE) {
									    if (chance1 >= 9990) {
									        ...
									        World.sendMessageNonDiscord(
									                "<img=11>@blu@[WOODCUTTING]<img=11> @red@" + player.getUsername()
