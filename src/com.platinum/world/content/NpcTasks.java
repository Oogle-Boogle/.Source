...
public class NpcTasks {
	...
	public enum NpcTaskData {
		...
		KILL_5000_LORD_VALOR("Kill 5000 lord Valors", 65617, "Desent Gear", new int[] { 10, 5000 },
				...
				new Item[] { new Item(10835, 500), new Item(19864, 100), new Item(19935, 1) }),
		KILL_500_HURRICANE_WARRIORS("Kill 500 Hurricane Warriors", 65618, "Desent Gear", new int[] { 11, 500 }, "Kill 500 Hurricane Warriors",
				...
				new Item[] { new Item(10835, 1), new Item(10835, 500), new Item(19864, 10), new Item(6199, 1) }),
		KILL_3000_HURRICANE_WARRIORS("Kill 3000 Hurricane Warriors", 65619, "Decent Gear", new int[] { 12, 3000 }, "Kill 3000 Hurricane Warriors",
				...
				new Item[] { new Item(19935, 1), new Item(10835, 250),new Item(3988, 1), new Item(19864, 25) }),
		...
		KILL_50_KINGKONG("Kill 50 King Kong", 65622, "Some Gear", new int[] { 15, 50 }, "Kill 50 King Kong",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(19935, 1), new Item(19864, 15),new Item(3988, 1) }),
		...
		KILL_500_CORP_BEAST("kill 500 Corp beasts", 65625, "Decent Gear", new int[] { 18, 500 }, "Kill 500 Corp beasts",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(10835, 350),new Item(19935, 1), new Item(19864, 50),new Item(3988, 1) }),
		KILL_2500_CORP_BEAST("kill 2500 Corp Beasts", 65626, "Decent Gear", new int[] { 19, 2500 }, "Kill 2500 Corp beasts",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(19936, 1), new Item(19864, 150),new Item(3988, 1) }),
		...
		KILL_2500_LUCID_WARRIORS("kill 2500 Lucid Warriors", 65628, "Decent Gear", new int[] { 21, 2500 },
				...
				new Item[] { new Item(10835, 350), new Item(19864, 55), new Item(19935, 1),new Item(3988, 1) }),
		...
		KILL_2500_DARKBLUE_WIZARDS("Kill 2500 Darkblue Wizards", 65633, "Decent Gear", new int[] { 26, 2500 },
				...
				new Item[] { new Item(10835, 200), new Item(19935, 1), new Item(19864, 100),new Item(3988, 1) }),
		...
		KILL_2500_CLOUD("Kill 2500 Cloud", 65639, "Decent Gear", new int[] { 32, 2500 },
				...
				new Item[] { new Item(19864, 100), new Item(10835, 100), new Item(19935, 1) }),
		...
		KILL_5000_HERBAL_ROGUE("Kill 5000 Herbal Rogue", 65641, "Some Gear", new int[] { 34, 5000 },
				...
				new Item[] { new Item(10835, 5000), new Item(19938, 1), new Item(19864, 100) }),
