...
import com.platinum.engine.task.impl.BonusExperienceTask;
...
import com.platinum.model.input.impl.BuyShards;
import com.platinum.model.input.impl.ChangePassword;
import com.platinum.model.input.impl.DonateTaxBagsInput;
import com.platinum.model.input.impl.DonateToWell;
import com.platinum.model.input.impl.EnterRaidParty;
import com.platinum.model.input.impl.SellShards;
import com.platinum.model.input.impl.SetEmail;
...
import com.platinum.world.content.Gambling.FlowersData;
...
import com.platinum.world.content.dialogue.impl.AgilityTicketExchange;
//import com.platinum.world.content.dialogue.impl.Arianwyn;
import com.platinum.world.content.dialogue.impl.Mandrith;
...
import com.platinum.world.entity.impl.npc.NpcAggression;
import com.platinum.world.entity.impl.player.Player;
import com.platinum.world.content.preset.Preset2;
import com.platinum.world.content.preset.Preset3;
import com.platinum.world.content.preset.Preset4;
import com.platinum.world.content.preset.Preset5;
		...
		if (id == FIRST_OPTION_OF_FIVE) {
			...
			case 743:
				if ((GameSettings.TRIPLE_EXP == true) || (GameSettings.DOUBLE_EXP == true)) {
					...
					World.sendMessage("<img=10>@blu@" + player.getUsername().toString()
					...
					t.schedule(new TimerTask() {
						...
						public void run() {
							...
							World.sendMessage("<img=10>@blu@ Triple Exp has ended");
						}
				...
				if (GameSettings.DOUBLE_BOSSPOINTS == true) {
					...
					t.schedule(new TimerTask() {
						...
						public void run() {
							...
							World.sendMessage("<img=10>@blu@ Double Boss Points has ended");
						}
				...
				if ((GameSettings.DOUBLE_EXP == true) || (GameSettings.TRIPLE_EXP == true)) {
					...
					t.schedule(new TimerTask() {
						...
						public void run() {
							...
							World.sendMessage("<img=10>@blu@ Double Exp has ended");
						}
			...
			case 71:
				...
				if (player.getInventory().contains(19670) && player.getClickDelay().elapsed(700)) {
					...
					player.getInventory().add(995, 5000000 * amt);
					...
					if (chance >= 900) {
						...
						World.sendMessage("<img=10>@blu@[WORLD]<img=10> " + player.getUsername().toString()
