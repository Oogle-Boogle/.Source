package com.platinum.world.entity.impl;
...
public abstract class Character extends Entity {
	...
	public Character moveTo(int x, int y, int z) {
		moveTo(new Position(x, y, z));
		return this;
	}


	public Character moveTo(Position teleportTarget) {
		//if (((Player) this).getMinigameAttributes().getDungeoneeringAttributes().getParty() != null) { 
			//if (teleportTarget.getY() < 4800 || teleportTarget.getY() > 5200)
			//((Player) this).getMinigameAttributes().getDungeoneeringAttributes().getParty().remove(((Player) this), true, true);
		//}
