...
import com.platinum.engine.task.impl.PlayerDeathTask;
...
import com.platinum.net.packet.PacketBuilder;
import com.platinum.net.packet.PacketSender;
import com.platinum.net.packet.ValueType;
import com.platinum.util.FrameUpdater;
...
import com.platinum.world.content.KillsTracker.KillsEntry;
import com.platinum.world.content.LoyaltyProgramme.LoyaltyTitles;
import com.platinum.world.content.NpcTasks.NpcTaskAttributes;
import com.platinum.world.content.StartScreen.GameModes;
import com.platinum.world.content.StarterTasks.StarterTaskAttributes;
import com.platinum.world.content.clan.ClanChat;
import com.platinum.world.content.collectionlog.CollectionEntry;
import com.platinum.world.content.collectionlog.CollectionLogInterface;
...
import com.platinum.world.content.combat.magic.CustomMagicStaff;
...
import com.platinum.world.content.combat.pvp.PlayerKillingAttributes;
...
import com.platinum.world.content.invansionminigame.InvasionGame;
...
import com.platinum.world.content.skill.impl.construction.HouseFurniture;
import com.platinum.world.content.skill.impl.construction.Portal;
import com.platinum.world.content.skill.impl.construction.Room;
import com.platinum.world.content.skill.impl.farming.Farming;
...
import com.platinum.world.content.skill.impl.summoning.Pouch;
...
import com.platinum.world.content.starterzone.StarterZone;
import com.platinum.world.entity.impl.Character;
import com.platinum.world.entity.impl.GroundItemManager;
import com.platinum.world.entity.impl.npc.Bosses.CustomBossInstance;
import com.platinum.world.entity.impl.npc.Bosses.Sagittare;
...
public class Player extends Character {
	...
	// u can take right method of killtracker yeah ik, just tryna see what suic was
	// doing that's all ;p
...
//my ones are not attacted is that the reaons why?? nah ud get errors
	...
	public int getAttackSpeed() {
		...
		if (weaponId == 13265 || weaponId == 19618 || weaponId == 19163 || weaponId == 9492 || weaponId == 2760
				...
				|| weaponId == 20427 || weaponId == 13201 || weaponId == 18891 || weaponId == 3282) {
			return 3;
		}
    ...
    public boolean isDonor() {
        return getRights() == PlayerRights.DONATOR || getRights() == PlayerRights.SUPER_DONATOR || getRights() == PlayerRights.EXTREME_DONATOR;
    }
