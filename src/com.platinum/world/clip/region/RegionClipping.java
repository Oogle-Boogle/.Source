package com.platinum.world.clip.region;
...
import com.platinum.world.clip.stream.ByteStream;
...
public final class RegionClipping {
	...
	public static boolean objectExists(GameObject object) {
		...
		boolean barbCourseRopeswing = id == 2282 && pos.getX() == 2551
				&& pos.getY() == 3550;
		boolean checkForWalls = id == 14 && pos.getX() >= 2595 && pos.getX() <= 2570 && pos.getY() == 4620 && pos.getY() == 4620;
		...
		if (well || mageBankLever || lawAltar || trees || chaosTunnels || lunar || barrows || rfd || lumbridgeCastle || barbCourseRopeswing || catherbyAquariums || freeForAllPortal || warriorsGuild || fightPit || checkForWalls || godwars || barrows || waterRcAltar || crystalChest)
			return true;
