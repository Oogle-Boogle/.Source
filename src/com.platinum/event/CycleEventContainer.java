...
public class CycleEventContainer {
	...
	/**
	 * Randomization occurs during the process of the main game loop. Events that are randomized
	 * are swapped randomly in execution order until there are none left.
	 * @return
	 */
