package com.platinum.world.content.droppreview;
...
public static final int[] NEXX = {11987, 14008, 14009, 14010, 14012, 14013, 14014, 14015, 14016, 4706};
...
public static void nextItem(Player player) {
	if (index == NEXX.length) {
		index = 0;
		player.getPacketSender().sendItemOnInterface(47900, NEXX[index++], 1);
	} else {
		player.getPacketSender().sendItemOnInterface(47900, NEXX[index++], 1);
	}
