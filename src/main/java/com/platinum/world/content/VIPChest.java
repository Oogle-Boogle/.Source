...
public class VIPChest {
	...
	public static int rareLoots[] = { 7682,7683,7684,7685,7686,7687,7688,19935,4794,4795,4796,4797,19127,19128,19129,13991,13992,13993,13994,13995,14447,14448 };

	//if random is 186 to 200, they get this table
	public static int ultraLoots[] = { 7759,7761,7762,7763,7760,7764,7765,19936,19938,9496,9497,9498,9499,10905,19155,19741,19742,19743,19744,13997,15374 };
	...
	public static void giveReward(Player player) {
		...
		if (random >= 1 && random <= 150) {
			...
			if (ultraDrops == 5561) {
				...
				World.sendMessage("@blu@[VIP CHEST]: " + player.getUsername() + " has received " + ItemDefinition.forId(ultraDrops).getName() + " from the VIP chest!");
			}
		}
	}
}
