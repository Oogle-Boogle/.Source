		...
		player.setWalkToTask(new WalkToTask(player, npc.getPosition(), npc.getSize(), new FinalizedMovementTask() {
			...
			public void execute() {
				...
				case 3212:
					...
					break;
				case 4475:
					int[] itemList2 = {989,15373,3928,15418,2572,18392,9006,6194,6195,6196,3973,3908,3910,3909,19886,5130,19468,18865,5134,3951,18957,5131,19720,15375,1959,5185,19727,19728,19729,19730,19731,19732,6485 };
