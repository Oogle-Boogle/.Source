...
public class DesolaceFormulas {
    ...
    public static int getAttackDelay(Player plr) {
        ...
        if (id == 3928 || id == 5130 || id == 18865 || id == 14006 || id == 16429 || id == 19468 || id == 16137) {
            return 4;
        }
        ...
        if (id == 19618 || id == 19163 || id == 9492 || id == 2760 || id == 19727 || id == 4059 || id == 6320 || id == 13207 || id == 8664 || id == 4796 || id == 18931 || id == 13995 || id == 10905 || id == 19154 || id == 20431 || id == 20427) {
            return 2;
        }
