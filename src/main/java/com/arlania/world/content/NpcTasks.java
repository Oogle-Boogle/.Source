...
import com.arlania.util.StringUtils;
...
public class NpcTasks {
	...
	public enum NpcTaskData {
		...
		KILL_50_JOKER("Kill 50 Jokers", 65607, "Some Gear", new int[] { 0, 50 }, "Kill 50 jokers @ ::starterzone", "", "",
				"", new Item[] { new Item(15373, 1),new Item(989, 2), new Item(7629, 20) }), // 14484 is itemid, 1 is amount
		...
		KILL_50_INFARTICO("Kill 50 Infartico", 65615, "Decent Gear", new int[] { 8, 50 },
				...
				new Item[] { new Item(10835, 100), new Item(7629, 30) }),
		KILL_500_LORD_VALOR("Kill 500 Lord Valors", 65616, "Decent Gear", new int[] { 9, 500 }, "Kill 500 Lord Valor",
				...
				new Item[] { new Item(10835, 100), new Item(7629, 10) }),
		KILL_5000_LORD_VALOR("Kill 5000 lord Valors", 65617, "Desent Gear", new int[] { 10, 5000 },
				...
				new Item[] { new Item(10835, 500), new Item(7629, 100), new Item(19935, 1) }),
		KILL_500_HURRICANE_WARRIORS("Kill 500 Hurricane Warriors", 65618, "Desent Gear", new int[] { 11, 500 }, "Kill 500 Hurricane Warriors",
				"Find them at hardened teleports", "Mass Boss", "",
				new Item[] { new Item(10835, 1), new Item(10835, 500), new Item(7629, 10), new Item(6199, 1) }),
		KILL_3000_HURRICANE_WARRIORS("Kill 3000 Hurricane Warriors", 65619, "Decent Gear", new int[] { 12, 3000 }, "Kill 3000 Hurricane Warriors",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(19935, 1), new Item(10835, 250),new Item(3988, 1), new Item(7629, 25) }),
		...
		KILL_500_LUCID_WARRIORS("kill 500 Lucid Warriors", 65627, "Decent Gear", new int[] { 20, 500 },
				...
				new Item[] { new Item(10835, 170), new Item(7629, 75) }),
		KILL_2500_LUCID_WARRIORS("kill 2500 Lucid Warriors", 65628, "Decent Gear", new int[] { 21, 2500 },
				...
				new Item[] { new Item(10835, 350), new Item(7629, 55), new Item(19935, 1),new Item(3988, 1) }),
		...
		KILL_10000_HULK("Kill 10000 Hulk", 65631, "Decent Gear", new int[] { 24, 10000 }, "Kill 10000 Hulk",
				"Find them at ::hulk", "", "",
				new Item[] { new Item(19092, 1), new Item(19936, 1),new Item(3988, 1), new Item(10835, 5000) }),
		KILL_500_DARKBLUE_WIZARDS("kill 500 Darkblue wizards", 65632, "Decent Gear", new int[] { 25, 500 }, "Kill 500 Darkblue wizards",
				...
				new Item[] { new Item(10835, 100), new Item(7629, 50),new Item(3988, 1) }),
		KILL_2500_DARKBLUE_WIZARDS("Kill 2500 Darkblue Wizards", 65633, "Decent Gear", new int[] { 26, 2500 },
				...
				new Item[] { new Item(10835, 200), new Item(19935, 1), new Item(7629, 100),new Item(3988, 1) }),
		KILL_10000_HEATED_PYRO("Kill 10000 Heated pyro", 65634, "Decent Gear", new int[] { 27, 10000 }, "Kill 10000 Heated pyros",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(19938, 1), new Item(10835, 500),new Item(3988, 1) }),
		KILL_2500_WYRM("kill 10000 Lucid Warriors", 65635, "Decent Gear", new int[] { 28, 2500 },
				...
				new Item[] {new Item(19935, 1), new Item(10835, 500) }),
		...
		KILL_1000_SUPREME_NEX("Kill 1000 Supreme Nex", 65645, "Some Gear", new int[] { 39, 1000 }, "Kill 1000 Supreme Nex",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(20054, 3), new Item(10835, 1), new Item(19935, 1), new Item(10835, 2500) }),
		KILL_5000_SUPREME_NEX("Kill 5000 Supreme Nex", 65646, "Some Gear", new int[] { 40, 5000 }, "Kill 5000 Supreme Nex",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(20054, 3), new Item(10835, 1), new Item(19936, 1), new Item(10835, 5000),new Item(3988, 2),new Item(15374, 1) }),
		KILL_10000_SUPREME_NEX("Kill 10000 Supreme Nex", 65647, "Some Gear", new int[] { 41, 10000 }, "Kill 10000 Supreme Nex",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5130, 10), new Item(10835, 5000), new Item(19938, 1),new Item(3988, 2) ,new Item(15374, 3)});
	...
	static int[] rewards = { 12434, 12435, 12436, 5130, 4646, 4645, 4644, 3286, 19936, 6570, 6183 };
