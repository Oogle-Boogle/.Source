...
import com.arlania.world.content.skill.impl.pvm.NpcGain;
...
public class Onslaught extends NPC {
	...
	public static Item[] RARELOOT = { 
			new Item(2749), new Item(2755), new Item(2754), new Item(18942), new Item(18941), new Item(18940), new Item(922),new Item(2753),  new Item(12502),
			new Item(2752), new Item(2750), new Item(2751),
			new Item(10835, 200) };
	 ...
	 */
	public static final OnslaughtLocation[] LOCATIONS = { new OnslaughtLocation(2417, 2861, 0, "") };
	...
	public static void spawn() {
		...
		World.sendMessage("<shad=1><img=418>@red@[Starter Boss] Onslaught has Respawned" + location.getLocation() + "!");
	}
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		if (chance >= 980) {
			...
			World.sendMessage(
					"<img=386><col=FF0000>" + player.getUsername() + " received " + itemMessage + " from Onslaught");
			return;
		}
