...
public class DailyNpc extends NPC {
	...
	public static void spawn() {
		...
		World.sendMessage("<img=392><shad=200><col=000000>[<col=b96900>HALLOWEEN<col=000000>]<col=b96900>Killer Pumpkin has respawned!  " + location.getLocation() + "!");
	}
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		if (chance >= 990) {
			...
			Misc.anOrA(itemName);
			World.sendMessage(
					"<img=382><col=FF0000>" + player.getUsername() +"received<col=eaeaea>[ " + itemName + "<col=eaeaea>]<col=FF0000>from Sephiroth");
			return;
		}
