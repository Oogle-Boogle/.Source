...
public class Tztok extends NPC {
	...
	public static int[] SUPERRARELOOT = {19936,5184,11978,19140,19886,6320,4058,4057,4056,4059,19890,12162 };
	 ...
	 */
	public static final TztokLocation[] LOCATIONS = { new TztokLocation(2412, 4670, 0, "<col=0999ad> <img=385> ::wb ") };
	...
	public static void spawn() {
		...
		World.sendMessage("<img=418><col=bababa>[<col=0999ad><shad=200>WORLD BOSS<col=bababa>]<col=0999ad>The World Boss has Respawned at <col=00a745>" + location.getLocation() + "");
	}
