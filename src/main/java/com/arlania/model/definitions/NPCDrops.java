...
import com.arlania.world.content.HourlyBoss;
import com.arlania.world.content.PetPerkData;
...
public class NPCDrops {
	...
	public enum DropChance {
		...
		LEGENDARY(150), LEGENDARY_2(250), LEGENDARY_3(400), LEGENDARY_4(750), LEGENDARY_5(2000),LEGENDARY_6(5000),LEGENDARY_7(7000);
	...
	public static void drop(Player player, Item item, NPC npc, Position pos, boolean goGlobal) {
		...
		if (pet != null && PetPerkData.hasLootEffect(pet.getSummonNpc().getId())) {
			...
			player.sendMessage("Added item to bank because of pet perk");
			return;
		}
