        ...
        switch (command[0]) {
            ...
            case "donated": {
                new java.lang.Thread() {
                    public void run() {
                        try {
                            com.everythingrs.donate.Donation[] donations = com.everythingrs.donate.Donation.donations("Sg3go6GjOMB0nV2iUiFmqAmwGxb5mj93i1KsWpvymi5awKjhtsfpjQnpWQ2snaBv4tsyWjt9",
                                    player.getUsername());
