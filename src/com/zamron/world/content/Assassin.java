...
public class Assassin extends NPC {
	...
	public static int[] RARELOOT = { 5131,4771,4772,4770,5131,4771,4772,4770, 4799 ,4800,4801,5079,3973,3951,15012
			,5131,4770,4771,4772,3988, 22204};
	...
	public static void spawn() {
		...
		World.sendMessageDiscord("<img=11><col=bababa><shad=10>[<col=0999ad>BOSS<col=bababa>]<col=0999ad>Assassin <col=00a745>has <shad=10>respawned <img=11> ::assassin");
	}
