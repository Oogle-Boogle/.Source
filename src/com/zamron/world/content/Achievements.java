...
public class Achievements {
	...
	public enum AchievementData {
		...
		SMELT_AN_IRON_BAR(AchievementDifficulty.EASY, "Smelt An Iron Bar", 45013, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		HARVEST_A_CROP(AchievementDifficulty.EASY, "Harvest A Crop", 45014, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		INFUSE_A_DREADFOWL_POUCH(AchievementDifficulty.EASY, "Infuse A Dreadfowl Pouch", 45015, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		CATCH_A_YOUNG_IMPLING(AchievementDifficulty.EASY, "Catch A Young Impling", 45016, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		CRAFT_A_PAIR_OF_LEATHER_BOOTS(AchievementDifficulty.EASY, "Craft A Pair of Leather Boots", 45017, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		CLIMB_AN_AGILITY_OBSTACLE(AchievementDifficulty.EASY, "Climb An Agility Obstacle", 45018, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		FLETCH_SOME_ARROWS(AchievementDifficulty.EASY, "Fletch Some Arrows", 45019, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		STEAL_A_RING(AchievementDifficulty.EASY, "Steal A Ring", 45020, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		MIX_A_POTION(AchievementDifficulty.EASY, "Mix A Potion", 45021, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		RUNECRAFT_SOME_RUNES(AchievementDifficulty.EASY, "Runecraft Some Runes", 45022, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		BURY_A_BIG_BONE(AchievementDifficulty.EASY, "Bury A Big Bone", 45023, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		COMPLETE_A_SLAYER_TASK(AchievementDifficulty.EASY, "Complete A Slayer Task", 45024, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		SET_UP_A_CANNON(AchievementDifficulty.EASY, "Set Up A Cannon", 45025, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		KILL_A_MONSTER_USING_MELEE(AchievementDifficulty.EASY, "Kill a Monster Using Melee", 45026, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		KILL_A_MONSTER_USING_RANGED(AchievementDifficulty.EASY, "Kill a Monster Using Ranged", 45027, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		KILL_A_MONSTER_USING_MAGIC(AchievementDifficulty.EASY, "Kill a Monster Using Magic", 45028, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_MELEE(AchievementDifficulty.EASY, "Deal 1000 Melee Damage", 45029, new int[]{0, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_RANGED(AchievementDifficulty.EASY, "Deal 1000 Ranged Damage", 45030, new int[]{1, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		DEAL_EASY_DAMAGE_USING_MAGIC(AchievementDifficulty.EASY, "Deal 1000 Magic Damage", 45031, new int[]{2, 1000}, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		PERFORM_A_SPECIAL_ATTACK(AchievementDifficulty.EASY, "Perform a Special Attack", 45032, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
		FIGHT_ANOTHER_PLAYER(AchievementDifficulty.EASY, "Fight Another Player", 45033, null, "", "", "", "", "", "",  new Item(10835, 1), new Item(8851, 10), new Item(19864, 10)),
