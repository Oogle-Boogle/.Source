...
public class CombatContainer {
	...
	private final CombatHit[] prepareHits(int hitAmount) {
		...
		if (attacker.isPlayer()) {
			if (((Player)attacker).getEquipment().containsAny( 19004,22205,16429, 18398, 17931 ,3651,18385,7682,7688,19620,19123,6930,3276,16550,5115,18683,1667,2543,6320,13094,6483,5131,6197,923,5130,13207,5132,15653,5195, 13201, 3072,14559,3941,896,5125,5130,5134,5195,5129,19618)) {
