...
public class Reminders {
	...
	private static final String[][] MESSAGE_DATA = { 
			...
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a> Use the command ::drop for drop tables"},
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a>Did you know you can get paid to make videos? PM Oogle"},
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a>Make sure you ::vote everyday for amazing Rewards!"},
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a>You can checkout our donation deals ::donationdeals"},
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a>Remember to complete your daily task as it resets every 24hr!"},
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a>Did you know? Slayer is a great way to earn a passive income!"},
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a>If you have any suggestions post them in our discord ::discord"},
			{"<img=11><col=eaeaea>[<col=60148a>SERVER<col=eaeaea>]<col=60148a>Would you like to see something ingame? Suggest it on ::discord!"},
